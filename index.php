...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/template-<?php echo $this->params->get('cor', 'verde'); ?>.css?v=g" type='text/css'/>
            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    ...
                    <div id="navigation" class="span3">
                        ...
                        foreach (array_reverse($menus) as $item) {
                            $params = json_decode($item->params);?>
                            <a href="/index.php/<?php echo $item->path; ?>" class="visible-phone visible-tablet btn"><i class="<?php echo $params->pageclass_sfx; ?>"><br></i><?php echo $params->{"menu-anchor_title"}; ?></a>
                        <?php
                        }
                        ?>
